 ...
 * @author 
 */
public class SegmenterAndEchoTranslationPipeline {
     ...
     */
    public SegmenterAndEchoTranslationPipeline(UimaAsBaseCallbackListener callback, String deployFile) throws Exception 
    {
...
//        uimaAsEngine.deploy("./conf/deploy.xml", deployCtx);
        ...
        deployCtx.put(UimaAsynchronousEngine.ENDPOINT,  "SegmenterAndEchoTranslationQueue");
//        deployCtx.put(UimaAsynchronousEngine.CasPoolSize, 15);
     ...
     */
    public void translate(String sourceLang, String targetLang, String text) throws CASException, Exception{
